...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '3b2dcf8f15a44cddbe086daecb1d4932',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jingsheng Chen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Robotic Engineer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jingsheng.dev', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'NotionNext, Jingsheng Chen, 陈敬升, Jingsheng, Exsusiai', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'chjingsheng@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Exsusiai', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BACKGROUND_LIGHT: '#fdfdfd', // use hex value, don't forget '#' e.g #fffefc
  ...
  NOTION_PROPERTY_NAME: {
    ...
    type_contact:
    process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_CONTACT || 'Contact', // 当type文章类型与此值相同时，为联系方式。
